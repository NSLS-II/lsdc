...
from ophyd import SingleTrigger, ProsilicaDetector, ImagePlugin, StatsPlugin, ROIPlugin
...
if beamline == "amx":
    ...
    eiger = EigerSingleTriggerV26(
        "XF:17IDB-ES:AMX{Det:Eig9M}", name="eiger", beamline=beamline
    )
    ...
    eiger = EigerSingleTriggerV26(
        "XF:17IDC-ES:FMX{Det:Eig16M}", name="eiger", beamline=beamline
    )
    from mxtools.vector_program import VectorProgram
    ...
    detector = EigerSingleTriggerV26(
        "XF:19ID-ES:NYX{Det:Eig9M}", name="detector", beamline=beamline
    )
    ...
    back_light = EpicsSignal(
        read_pv="XF:19IDD-CT{DIODE-Box_D1:4}InCh00:Data-RB",
        write_pv="XF:19IDD-CT{DIODE-Box_D1:4}OutCh00:Data-SP",
        name="back_light",
    )
    back_light_low_limit = EpicsSignalRO(
        "XF:19IDD-CT{DIODE-Box_D1:4}CfgCh00:LowLimit-RB", name="back_light_low_limit"
    )
    back_light_high_limit = EpicsSignalRO(
        "XF:19IDD-CT{DIODE-Box_D1:4}CfgCh00:HighLimit-RB", name="back_light_high_limit"
    )
