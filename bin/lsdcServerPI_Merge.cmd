...
export PYTHONPATH=".:${CONFIGDIR}:/usr/local/albula_py3/dectris/albula/3.2/python:/usr/local/edna-mx/mxv1/src:/usr/local/edna-mx/kernel/src:${LSDCHOME}:${PROJDIR}/RobotControlMerge"
