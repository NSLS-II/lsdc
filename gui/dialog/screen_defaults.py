...
from config_params import (VALID_EXP_TIMES, RASTER_TUNE_LOW_RES, 
                           RASTER_TUNE_HIGH_RES, RASTER_TUNE_RESO_FLAG,
                           RASTER_TUNE_ICE_RING_WIDTH, RASTER_TUNE_ICE_RING_FLAG,
