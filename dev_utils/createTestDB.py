...
def addCameraParams():
	...
	# Zoom URLs are currently the same, but will over-move when used for C2C, need the ROIs here
        ...
        setBeamlineConfigParam(beamline, 'lowMagFOVx', '190')
        setBeamlineConfigParam(beamline, 'lowMagFOVy', '150')
        setBeamlineConfigParam(beamline, 'highMagFOVx', '190')
        setBeamlineConfigParam(beamline, 'highMagFOVy', '150')
