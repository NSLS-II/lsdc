...
export PYTHONPATH="/nsls2/data/amx/shared/config/bluesky_overlay/lsdc-server-2022-2.3/lib/python3.9/site-packages:.:${CONFIGDIR}:/usr/lib64/edna-mx/mxv1/src:/usr/lib64/edna-mx/kernel/src:${LSDCHOME}:${PROJDIR}/RobotControlLib"
