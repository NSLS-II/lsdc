...
if (beamline == "amx"):
  command_string = "/usr/local/edna-mx/mxv1/bin/edna-mxv1-characterisation --verbose --image " + "edna_image_0001.cbf" + " " + "edna_image_0002.cbf" + " --flux " + str(flux) + " --transmission " + str(transmission) + " --minExposureTimePerImage 0.005 --beamSize 0.006"
else:
  command_string = "/usr/local/edna-mx/mxv1/bin/edna-mxv1-characterisation --verbose --image " + "edna_image_0001.cbf" + " " + "edna_image_0002.cbf" + " --flux " + str(flux) + " --transmission " + str(transmission) + " --minExposureTimePerImage 0.01 --beamSize 0.004"
